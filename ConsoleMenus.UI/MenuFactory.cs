...
internal static class MenuFactory
{
    internal static Menu GetMainMenu()
    {
        ...
        MenuOption sub2opt2 = new("2 = option 2", 2, [ConsoleKey.D2, ConsoleKey.NumPad2], () => Console.WriteLine("SubMenu 2 option 2 selected"));
        MenuOption sub2opt3 = new("3 = option 3", 3, [ConsoleKey.D3, ConsoleKey.NumPad3], () => Console.WriteLine("SubMenu 2 option 3 selected"));
